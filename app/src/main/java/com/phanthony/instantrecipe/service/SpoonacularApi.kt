...
interface SpoonacularApi {
    ...
    @GET("recipes/findByIngredients?number=100&ignorePantry=true")
    fun getRecipes(@Query("ingredients", encoded = true) ingredients: String, @Query("apiKey") apiKey: String, @Query("ranking") ranking: Int)
